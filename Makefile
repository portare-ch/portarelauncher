...
SRC  := src/text.c src/proc.c src/update.c src/osinfo.c src/net.c src/bt.c src/osk.c src/tools.c src/settings.c src/status.c src/osd.c src/term.c src/kms.c \
...
TESTS := tests/test_text tests/test_settings tests/test_proc \
         ...
         tests/test_osk tests/test_update tests/test_osinfo
