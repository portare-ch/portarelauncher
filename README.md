...
Update all work. Update asks GitHub what the chosen channel - nightly or
release - has for this device, downloads it over Wi-Fi with a progress bar,
and offers a restart once portareos-update has checked and staged it. Wi-Fi lists saved profiles and what is in range, connects to a saved
